...
namespace Kampute.HttpClient.NewtonsoftJson
{
    ...
    public static class HttpRestClientJsonExtensions
    {
        ...
        /// <param name="settings">The <see cref="JsonSerializerSettings"/> to use for serializing payload as JSON. if <c>null</c>, default settings will be used.</param>
        ...
        /// <returns>The <see cref="JsonSerializerSettings"/> if set; otherwise, <c>null</c>.</returns>
        ...
        /// </summary>
        /// <param name="client">The <see cref="HttpRestClient"/> instance to configure.</param>
        /// <param name="settings">The <see cref="JsonSerializerSettings"/> to use for deserializing JSON responses. if <c>null</c>, default settings will be used.</param>
        ...
        )
        {
            ...
            using var content = new JsonContent(payload) { Settings = client.GetJsonSerializerSettings() };
