...
namespace Kampute.HttpClient.DataContract
{
    ...
    public static class HttpRestClientXmlExtensions
    {
        ...
        /// <param name="settings">The <see cref="DataContractSerializerSettings"/> to use for serializing payload as XML. If <c>null</c>, default settings will be used.</param>
        ...
        /// </summary>
        /// <param name="client">The <see cref="HttpRestClient"/> instance to configure.</param>
        /// <param name="settings">The <see cref="DataContractSerializerSettings"/> to use for deserializing XML responses. if <c>null</c>, default settings will be used.</param>
