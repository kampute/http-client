namespace Kampute.HttpClient.Content.Abstracts
{
    ...
    public abstract class HttpContentDeserializer : IHttpContentDeserializer
    {
        ...
        /// <exception cref="ArgumentNullException">Thrown if <paramref name="supportedMediaTypes"/> is <c>null</c>.</exception>
        ...
        /// <returns>A task representing the asynchronous read operation, which upon completion contains the deserialized object, or <c>null</c> if deserialization fails.</returns>
        /// <exception cref="ArgumentNullException">Thrown if either <paramref name="content"/> or <paramref name="modelType"/> is <c>null</c>.</exception>
