namespace Kampute.HttpClient.RetryManagement.Strategies.Modifiers
{
    ...
    public sealed class LimitedDurationStrategyModifier : IRetryStrategy
    {
        ...
        /// <returns><c>true</c> if the total elapsed time is within the specified timeout and the underlying strategy indicates that a retry should be attempted; otherwise, <c>false</c>.</returns>
